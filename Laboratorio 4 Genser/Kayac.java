...
public class Kayac {
    ...
    public void cambiarContraseña(Usuario usuario) {
        ...
        if (cambioContrasena == "Si"){
            ...
            System.out.println("La contraseña no a sido cambiada");
        }
    ...
    public void realizarConfirmacion(Reserva reserva) {
        ...
        reserva.definirCantidadCuotas();
        String status1 = usuario.getTipo();
        if (status1.equals("Regular") || status1.equals("regular")) {
            System.out.println("Su vuelo es clase media");
        }
            
        else if (status1.equals("Premium") || status1.equals("premium")) {
            System.out.println("Por ser premium su vuelo es de (Primera clase)");
        }

        else {
            System.out.println("No se pudo encontrar a que status de usuario pertence");
        }
        
        reserva.imprimirItinerario();}
